...
import io.hustler.freshcopartner.di.components.DaggerFragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent(): FragmentComponent =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as PartnerApplication).applicationComponent)
